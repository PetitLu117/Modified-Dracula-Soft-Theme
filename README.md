...
Here is the [Modified Dracula Soft Theme](https://github.com/PetitLu117/Modified-Dracula-Soft-Theme) github repository where the json files are ([here](https://github.com/PetitLu117/Modified-Dracula-Soft-Theme/blob/main/yaml-to-json/themes)) and the files that generated them ([here](https://github.com/PetitLu117/Modified-Dracula-Soft-Theme/blob/main/yaml-to-json/scripts)).
